...
<div class="action_wrapper_1">
	...
	<div class="form-group">
		...
		{{ Form::input('email', 'email', Input::old('email'), ['class'=>'form-control', 'id'=>'email']) }}
	</div>
	...
	<div class="form-group">
		...
		<div class="type_wrap_1">
			<label class="radio-inline">
				 {{ Form::radio('type', '0', Input::old('type')) }} ადმინისტრატორი
			</label>
			<label class="radio-inline">
				 {{ Form::radio('type', '1', Input::old('type')) }} სტუდენტი
			</label>
			<label class="radio-inline">
	...
	<div class="form-group">
			...
			{{ Form::textarea('description', Input::old('description'), ['class' => 'field form-control', 'size' => '30x5', 'id' => 'about_youtself_1']) }}
	</div>
